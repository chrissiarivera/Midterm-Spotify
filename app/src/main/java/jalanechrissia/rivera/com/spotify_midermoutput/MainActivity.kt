...
class MainActivity : AppCompatActivity() {
    ...
    var songModel = ArrayList<SongModel>()
    companion object {
    ...
    public fun setSelectedSong(pos: Int){
        for(item in songModel){
            item.stat = 0
        }
        songModel.get(pos).stat = 1

        val adapter = CustomAdapter(songModel,applicationContext,this)
    ...
    private fun initCollapsingToolbar() {
        ...
        val collapsingToolbar = findViewById<View>(R.id.collapsingToolbarLayout) as CollapsingToolbarLayout
